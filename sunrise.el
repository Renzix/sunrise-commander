...
(define-key sunrise-mode-map "\C-c="           'sunrise-diff)
(define-key sunrise-mode-map "="       'sunrise-ediff)
...
(define-key sunrise-mode-map "l"        'sunrise-locate)
...
(define-key sunrise-mode-map "s"        'sunrise-sticky-isearch-forward)
(define-key sunrise-mode-map "r"        'sunrise-sticky-isearch-backward)
