...
(define-key sunrise-mode-map "\C-l"        'sunrise-locate)
...
(define-key sunrise-mode-map "\C-s"        'sunrise-sticky-isearch-forward)
(define-key sunrise-mode-map "\C-r"        'sunrise-sticky-isearch-backward)
